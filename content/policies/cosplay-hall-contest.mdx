...
**Judging is done through a pre-registration system. [You MUST pre-register in order to compete](https://forms.gle/9Fa4YEQ42XYm6coc7). We will have very few at-con sign up slots available.** The judging session times have not been set, check back closer to the convention for details.
