...
Attendees with a valid sponsor badge (Gold and Diamond levels) and a Line Hop Ticket will be granted front of the line access to one guest of honor of their choice.
...
All service animals are welcome in all spaces at BronyCon. However, due to Baltimore Convention Center policies, all service animals except those who assist the physically challenged must obtain written approval from the BCC prior to coming on site. Contact [info@bccenter.org](mailto:info@bccenter.org) for this approval.
